...
using DemoX.Data;
using DemoX.Filter;
using DemoX.Entities;
using DemoX.Logger;
using Microsoft.AspNetCore.JsonPatch;
using System.Linq.Expressions;

namespace DemoX.Services
{
    /// <summary>
    ...
    public interface IVisitChiefComplaintService
    {
        ...
        VisitChiefComplaint GetById(Guid id);
        ...
        List<VisitChiefComplaint> Get(List<FilterCriteria> filters = null, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc");

        /// <summary>Adds a new visitchiefcomplaint</summary>
        /// <param name="model">The visitchiefcomplaint data to be added</param>
        /// <returns>The result of the operation</returns>
        Guid Create(VisitChiefComplaint model);
        ...
        /// <returns>The result of the operation</returns>
        bool Update(Guid id, VisitChiefComplaint updatedEntity);

        /// <summary>Updates a specific visitchiefcomplaint by its primary key</summary>
        /// <param name="id">The primary key of the visitchiefcomplaint</param>
        /// <param name="updatedEntity">The visitchiefcomplaint data to be updated</param>
        /// <returns>The result of the operation</returns>
        bool Patch(Guid id, JsonPatchDocument<VisitChiefComplaint> updatedEntity);
    ...
    {
        private DemoXContext _dbContext;

        /// <summary>
        /// Initializes a new instance of the VisitChiefComplaint class.
        /// </summary>
        /// <param name="dbContext">dbContext value to set.</param>
        public VisitChiefComplaintService(DemoXContext dbContext)
        {
        ...
        /// <param name="id">The primary key of the visitchiefcomplaint</param>
        /// <returns>The visitchiefcomplaint data</returns>
        public VisitChiefComplaint GetById(Guid id)
        {
            var entityData = _dbContext.VisitChiefComplaint.IncludeRelated().FirstOrDefault(entity => entity.Id == id);
            return entityData;
        }
        ...
        public List<VisitChiefComplaint> Get(List<FilterCriteria> filters = null, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc")
        {
            var result = GetVisitChiefComplaint(filters, searchTerm, pageNumber, pageSize, sortField, sortOrder);
            return result;
        }
        ...
        /// <param name="model">The visitchiefcomplaint data to be added</param>
        /// <returns>The result of the operation</returns>
        public Guid Create(VisitChiefComplaint model)
        {
            model.Id = CreateVisitChiefComplaint(model);
            return model.Id;
        }
        ...
        public bool Update(Guid id, VisitChiefComplaint updatedEntity)
        {
            UpdateVisitChiefComplaint(id, updatedEntity);
            return true;
        }
        ...
        /// <returns>The result of the operation</returns>
        /// <exception cref="Exception"></exception>
        public bool Patch(Guid id, JsonPatchDocument<VisitChiefComplaint> updatedEntity)
        {
            PatchVisitChiefComplaint(id, updatedEntity);
            return true;
        }
        ...
        {
            DeleteVisitChiefComplaint(id);
            return true;
        }
        #region
        private List<VisitChiefComplaint> GetVisitChiefComplaint(List<FilterCriteria> filters = null, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc")
        {
            if (pageSize < 1)
            {
        ...
        private Guid CreateVisitChiefComplaint(VisitChiefComplaint model)
        {
        ...
        private void UpdateVisitChiefComplaint(Guid id, VisitChiefComplaint updatedEntity)
        {
            _dbContext.VisitChiefComplaint.Update(updatedEntity);
            _dbContext.SaveChanges();
        }

        private bool DeleteVisitChiefComplaint(Guid id)
        {
            var entityData = _dbContext.VisitChiefComplaint.IncludeRelated().FirstOrDefault(entity => entity.Id == id);
            if (entityData == null)
            {
        ...
        private void PatchVisitChiefComplaint(Guid id, JsonPatchDocument<VisitChiefComplaint> updatedEntity)
        {
