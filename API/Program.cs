...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "DemoX", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<DemoXContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "DemoX API v1");
