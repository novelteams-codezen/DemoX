...
namespace DemoX.Controllers
{
    ...
    public class VisitModeController : ControllerBase
    {
        ...
        {
            var id = _visitModeService.Create(model);
            return Ok(new { id });
        }
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var result = _visitModeService.Get(filterCriteria, searchTerm, pageNumber, pageSize, sortField, sortOrder);
            return Ok(result);
        }
        ...
        {
            var result = _visitModeService.GetById(id);
            return Ok(result);
        }
        ...
        {
            var status = _visitModeService.Delete(id);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] VisitMode updatedEntity)
        {
            ...
            var status = _visitModeService.Update(id, updatedEntity);
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<VisitMode> updatedEntity)
        {
            ...
            var status = _visitModeService.Patch(id, updatedEntity);
            return Ok(new { status });
        }
    }
}