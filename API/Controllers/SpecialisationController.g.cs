...
namespace DemoX.Controllers
{
    ...
    public class SpecialisationController : ControllerBase
    {
        ...
        {
            var id = _specialisationService.Create(model);
            return Ok(new { id });
        }
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var result = _specialisationService.Get(filterCriteria, searchTerm, pageNumber, pageSize, sortField, sortOrder);
            return Ok(result);
        }
        ...
        {
            var result = _specialisationService.GetById(id);
            return Ok(result);
        }
        ...
        {
            var status = _specialisationService.Delete(id);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] Specialisation updatedEntity)
        {
            ...
            var status = _specialisationService.Update(id, updatedEntity);
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<Specialisation> updatedEntity)
        {
            ...
            var status = _specialisationService.Patch(id, updatedEntity);
            return Ok(new { status });
        }
    }
}