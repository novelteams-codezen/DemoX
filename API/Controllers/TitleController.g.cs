...
namespace DemoX.Controllers
{
    ...
    public class TitleController : ControllerBase
    {
        ...
        {
            var id = _titleService.Create(model);
            return Ok(new { id });
        }
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var result = _titleService.Get(filterCriteria, searchTerm, pageNumber, pageSize, sortField, sortOrder);
            return Ok(result);
        }
        ...
        {
            var status = _titleService.Delete(id);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] Title updatedEntity)
        {
            ...
            var status = _titleService.Update(id, updatedEntity);
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<Title> updatedEntity)
        {
            ...
            var status = _titleService.Patch(id, updatedEntity);
            return Ok(new { status });
        }
    }
}