...
namespace DemoX.Controllers
{
    ...
    public class BloodGroupController : ControllerBase
    {
        ...
        {
            var id = _bloodGroupService.Create(model);
            return Ok(new { id });
        }
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var result = _bloodGroupService.Get(filterCriteria, searchTerm, pageNumber, pageSize, sortField, sortOrder);
            return Ok(result);
        }
        ...
        {
            var status = _bloodGroupService.Delete(id);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] BloodGroup updatedEntity)
        {
            ...
            var status = _bloodGroupService.Update(id, updatedEntity);
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<BloodGroup> updatedEntity)
        {
            ...
            var status = _bloodGroupService.Patch(id, updatedEntity);
            return Ok(new { status });
        }
    }
}