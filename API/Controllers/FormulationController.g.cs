...
namespace DemoX.Controllers
{
    ...
    public class FormulationController : ControllerBase
    {
        ...
        {
            var id = _formulationService.Create(model);
            return Ok(new { id });
        }
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var result = _formulationService.Get(filterCriteria, searchTerm, pageNumber, pageSize, sortField, sortOrder);
            return Ok(result);
        }
        ...
        {
            var result = _formulationService.GetById(id);
            return Ok(result);
        }
        ...
        {
            var status = _formulationService.Delete(id);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] Formulation updatedEntity)
        {
            ...
            var status = _formulationService.Update(id, updatedEntity);
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<Formulation> updatedEntity)
        {
            ...
            var status = _formulationService.Patch(id, updatedEntity);
            return Ok(new { status });
        }
    }
}