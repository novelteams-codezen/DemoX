...
namespace DemoX.Controllers
{
    ...
    public class DiagnosisController : ControllerBase
    {
        ...
        {
            var id = _diagnosisService.Create(model);
            return Ok(new { id });
        }
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var result = _diagnosisService.Get(filterCriteria, searchTerm, pageNumber, pageSize, sortField, sortOrder);
            return Ok(result);
        }
        ...
        {
            var result = _diagnosisService.GetById(id);
            return Ok(result);
        }
        ...
        {
            var status = _diagnosisService.Delete(id);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] Diagnosis updatedEntity)
        {
            ...
            var status = _diagnosisService.Update(id, updatedEntity);
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<Diagnosis> updatedEntity)
        {
            ...
            var status = _diagnosisService.Patch(id, updatedEntity);
            return Ok(new { status });
        }
    }
}