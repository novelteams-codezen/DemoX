...
namespace DemoX.Controllers
{
    ...
    public class PatientPregnancyController : ControllerBase
    {
        ...
        {
            var id = _patientPregnancyService.Create(model);
            return Ok(new { id });
        }
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var result = _patientPregnancyService.Get(filterCriteria, searchTerm, pageNumber, pageSize, sortField, sortOrder);
            return Ok(result);
        }
        ...
        {
            var result = _patientPregnancyService.GetById(id);
            return Ok(result);
        }
        ...
        {
            var status = _patientPregnancyService.Delete(id);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] PatientPregnancy updatedEntity)
        {
            ...
            var status = _patientPregnancyService.Update(id, updatedEntity);
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<PatientPregnancy> updatedEntity)
        {
            ...
            var status = _patientPregnancyService.Patch(id, updatedEntity);
            return Ok(new { status });
        }
    }
}