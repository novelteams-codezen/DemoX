...
namespace DemoX.Controllers
{
    ...
    public class CountryController : ControllerBase
    {
        ...
        {
            var id = _countryService.Create(model);
            return Ok(new { id });
        }
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var result = _countryService.Get(filterCriteria, searchTerm, pageNumber, pageSize, sortField, sortOrder);
            return Ok(result);
        }
        ...
        {
            var status = _countryService.Delete(id);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] Country updatedEntity)
        {
            ...
            var status = _countryService.Update(id, updatedEntity);
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<Country> updatedEntity)
        {
            ...
            var status = _countryService.Patch(id, updatedEntity);
            return Ok(new { status });
        }
    }
}